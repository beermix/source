...
block-mount wget libustream-openssl ca-certificates \
default-settings luci luci-app-upnp luci-app-sfe luci-app-filetransfer luci-app-arpbind luci-app-cpufreq
# For the basic set
