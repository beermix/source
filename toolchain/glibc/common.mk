...
PKG_MIRROR_HASH:=a98b8b221cfe732dc7c19ae1d22665002e254c96
...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -m32 -march=bonnell -mstackrealign -Wl,-z,max-page-size=0x1000 $(filter-out -fomit-frame-pointer -fno-plt -march=bonnell -O2 -m32 -pipe -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
