...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -m32 -march=bonnell -mstackrealign -g2  -Wl,-z,max-page-size=0x1000 $(filter-out -fno-plt -fomit-frame-pointer -march=bonnell -O2 -pipe -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
