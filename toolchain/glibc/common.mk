...
PKG_SOURCE_VERSION:=be9a328c93834648e0bec106a1f86357d1a8c7e1
...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -g $(filter-out -O2 -falign-functions=32 -fno-caller-saves -fno-plt -pipe -fomit-frame-pointer,$(call qstrip,$(TARGET_CFLAGS)))" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
