...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 $(filter-out -march=bonnell --param=l1-cache-size=24 --param=l1-cache-line-size=64 --param=l2-cache-size=512 -mtune=bonnell -fomit-frame-pointer -fno-caller-saves -fno-plt,$(call qstrip,$(TARGET_CFLAGS)))" \
	CPPFLAGS="" \
	CXXFLAGS="$(CFLAGS)" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
