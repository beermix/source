...
PKG_SOURCE_VERSION:=ef4e158c736d067304164c3daa763e4f425af248
PKG_MIRROR_HASH:=
...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -g $(filter-out -fno-caller-saves -fomit-frame-pointer -O2 -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
