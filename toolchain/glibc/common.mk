...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -m32 -march=bonnell -mstackrealign -g $(filter-out -fno-plt -fomit-frame-pointer -fno-caller-saves -fno-plt -march=bonnell -O2 -m32 -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
