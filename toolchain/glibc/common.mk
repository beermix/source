...
PKG_SOURCE_VERSION:=eed005270a472fe97e0a93540387bb8c81a8e36b
PKG_MIRROR_HASH:=
...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 -g -fno-stack-protector $(filter-out -fomit-frame-pointer -fno-caller-saves -fno-plt -D_FORTIFY_SOURCE=1 -D_FORTIFY_SOURCE=2 -fstack-protector -znow -zrelro -O2 -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
