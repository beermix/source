...
PKG_SOURCE_VERSION:=acfe409119f5db9429a2a2235fd2ad1242940cac
PKG_MIRROR_HASH:=
...
GLIBC_CONFIGURE:= \
	...
	CFLAGS="-O2 $(filter-out -fno-caller-saves -fno-plt -fomit-frame-pointer -O2 -Os,$(call qstrip,$(TARGET_CFLAGS)))" \
	libc_cv_slibdir="/lib" \
	use_ldconfig=no \
