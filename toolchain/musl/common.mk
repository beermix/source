...
TARGET_CFLAGS:= $(filter-out -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O%,$(TARGET_CFLAGS))
TARGET_CPPFLAGS:= $(filter-out -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O%,$(TARGET_CPPFLAGS))
