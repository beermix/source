...
GCC_MAKE:= \
	...
	$(MAKE) \
		CFLAGS="$(HOST_CFLAGS)" \
		CFLAGS_FOR_TARGET="-march=bonnell -g1 -O2 -pipe -fhonour-copts -Wl,-z,max-page-size=0x1000" \
		CXXFLAGS_FOR_TARGET="-march=bonnell -g1 -O2 -pipe -fhonour-copts -Wl,-z,max-page-size=0x1000" \
